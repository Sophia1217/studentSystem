...
//列表
export function queryCjffList(query) {
  return request({
    url: "/jcjyCjff/queryCjffList",
    method: "post",
    data: query,
  });
}
//导入
export function daoru(query) {
  return request({
    url: "/jcjyCjff/importExcelJcjyCjff",
    method: "post",
    data: query,
    responseType: "blob",
  });
...
//模板
export function downLoadCjff(query) {
  return request({
    url: "/jcjyCjff/downLoadCjff",
    method: "post",
    data: query,
    responseType: "blob",
  });
...
export function daochu(query) {
  return request({
    url: "/jcjyCjff/excelExportJcjyCjffDqr",
    method: "post",
    data: query,
    responseType: "blob",
  });
...
export function xinzeng(query) {
  return request({
    url: "/jcjyCjff/insertCjyCjff",
    method: "post",
    data: query,
  });
}
