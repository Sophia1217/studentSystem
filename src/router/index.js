  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "selectRole",
        hidden: false,
        meta: { title: "角色选择", icon: "", affix: true },
      },
      {
        path: "selectRole2",
        ...
        name: "selectRole2",
        hidden: false,
        meta: { title: "角色选择2", icon: "", affix: true },
      },
      {
        path: "selectRole3",
        ...
        name: "selectRole3",
        hidden: false,
        meta: { title: "角色选择3", icon: "", affix: true },
      },
      {
        path: "selectRole4",
        ...
        name: "selectRole4",
        hidden: false,
        meta: { title: "角色选择4", icon: "", affix: true },
      },
      {
        path: "selectRoleMore",
        ...
        name: "selectRoleMore",
        hidden: false,
        meta: { title: "更多角色选择", icon: "", affix: true },
      },
      {
        path: "studentAngle",
