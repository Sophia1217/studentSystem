      ...
      <div class="mt15">
        ...
        >
          ...
          <el-table-column
            ...
            width="50"
          ></el-table-column> -->
          <el-table-column prop="gzdw" label="工作单位" min-width="110">
          </el-table-column>
          <el-table-column prop="fdyzp" label="辅导员自评进度" min-width="155">
          </el-table-column>
          <el-table-column prop="xscp" label="学生测评进度" min-width="155">
          </el-table-column>
          <el-table-column prop="thhp" label="同行互评进度" min-width="155">
          </el-table-column>
          <el-table-column prop="dwjd" label="单位鉴定进度" min-width="155">
          </el-table-column>
          <el-table-column prop="xxpj" label="学校评价进度" min-width="155">
          </el-table-column>
...
import { queryCpjdXy } from "@/api/test/allTest";
...
export default {
  ...
  methods: {
    ...
    async hadleDetail(row) {
      this.$router.push({
        path: "/assistantTest/testProgress",
        query: {
          gzdwm: row.gzdwm,
        },
      });
