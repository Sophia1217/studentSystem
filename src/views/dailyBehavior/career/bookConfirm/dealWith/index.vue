<template>
  <div class="talkRec">
    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        ...
        <div class="headerRight">
          ...
          <div class="btns borderRed" @click="chehui">
            <i class="icon refuseIcon"></i><span class="title">取消</span>
          </div>
    ...
    <el-dialog title="取消" :visible.sync="chehuiModal" width="20%">
      <span>确认取消预约？</span>
      <span slot="footer" class="dialog-footer">
  ...
  methods: {
    ...
    expor() {
      let data = {
        ...
        lsztList: this.moreIform.lsztList,
    ...
    chConfirm() {
      lsCancel({ ids: this.delArr }).then((res) => {
        this.handleSearch();
