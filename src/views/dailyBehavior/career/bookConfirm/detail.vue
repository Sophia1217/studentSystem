...
export default {
  ...
  methods: {
    ...
    //     this.$set(this.detailInfoData, "yyid", this.yyid);
    //     this.$set(this.detailInfoData, "mtfs", this.mtfs); //1线上，2线下,
    //     this.$set(this.detailInfoData, "gzwtList", this.dmxbmOPs.choose || []);
