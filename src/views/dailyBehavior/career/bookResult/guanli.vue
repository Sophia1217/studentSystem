      ...
      <div class="search">
        ...
        >
          ...
          >
            ...
            <el-option label="咨询师工号" value="zxsGh"></el-option>
    ...
    <div class="tableWrap mt15">
      ...
      <div class="mt15">
        ...
        >
          ...
          <el-table-column prop="zxsXm" label="咨询师" min-width="100" sortable>
          </el-table-column>
          <el-table-column
            prop="yyrq"
            label="预约日期"
...
import { consultedListAuth } from "@/api/career/result";
  ...
  methods: {
    ...
    handleSearch() {
      ...
      let data = {
        ...
        xh: this.select == "xh" ? this.searchVal : null,
        yydd: this.select == "yydd" ? this.searchVal : null,
        zxsGh: this.select == "zxsGh" ? this.searchVal : null,
        pydwmList: this.moreIform.dwhList,
        zydmList: this.moreIform.zydmList,
