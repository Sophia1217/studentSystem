        ...
        <el-table :data="tableData.zxghList" style="width: 100%">
          ...
          <el-table-column prop="sjzxrq" label="实际咨询日期">
            <template slot-scope="scope">
              <div v-if="scope.row.id">{{ scope.row.sjzxrq }}</div>
              <el-date-picker
                v-else
                type="date"
                placeholder="请选择日期"
          ...
          <el-table-column prop="sjzxsj" label="实际咨询时间">
            <template slot-scope="scope">
              <div v-if="scope.row.id">{{ scope.row.sjzxsj }}</div>
              <el-time-picker
                v-else
                is-range
                v-model="scope.row.sjzxsj"
                format="HH:mm"
                value-format="HH:mm"
                range-separator="至"
          ...
          <el-table-column prop="mtfs" label="面谈方式">
            <template slot-scope="scope">
              <div v-if="scope.row.id">{{ scope.row.mtfs }}</div>
              <el-select
                v-else
