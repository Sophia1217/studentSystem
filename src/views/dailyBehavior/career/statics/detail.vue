    ...
    <div class="tableWrap mt15">
      ...
      <div class="mt15">
        ...
        >
          ...
          <el-table-column prop="pf" label="评分" min-width="100">
          </el-table-column>
          <!-- <el-table-column fixed="right" label="评分" width="140">
...
export default {
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      excelExportStu(this.exportParams)
        .then((res) => {
