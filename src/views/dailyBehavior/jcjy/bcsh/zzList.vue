    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        <div class="headerLeft">
          <span class="title">贷款补偿审核列表</span>
        ...
        <div class="headerRight">
          ...
          <div class="btns fullGreen" @click="quren">
...
export default {
  ...
  data() {
    return {
      //模板下载
      uploadUrl:
        process.env.VUE_APP_BASE_API + "/jcjyDkbc/importExcelJcjyQgzzzx",
      jgzt: [
        { dm: "09", mc: "拒绝" },
        { dm: "10", mc: "通过" },
      ],
    ...
    delList() {
      ...
      if (delArr.length > 0) {
        this.$confirm("即将删除, 是否继续?", "提示", {
          ...
          .then(() => {
            delAllList({ ids: delArr }).then((res) => {
              this.$message({
                type: "success",
                message: "删除成功!",
              });
