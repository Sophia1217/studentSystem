...
import { getYclList } from "@/api/dailyBehavior/vocationTea";
...
export default {
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      excelLsYclList(this.exportParams)
        .then((res) => {
          this.downloadFn(res, "请假列表已处理列表导出.xlsx", "xlsx");
