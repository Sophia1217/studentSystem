    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        <div class="headerLeft">
          <span class="title">复学</span> <i class="Updataicon"></i>
        </div>
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="10">
              <el-form-item
                ...
                :rules="rules.SFRZ"
              >
                <div v-if="editFlag == 2">{{ formEdit.SFRZ }}</div>
                <el-select
  ...
  methods: {
    ...
    editClick() {
      if (!this.checkFormEdit()) {
        ...
        formData.append("fxSfsqrz", data.fxSfsqrz);
    ...
    addClick() {
      if (!this.checkFormAdd()) {
        ...
        formData.append("fxSfsqrz", data.sfRz);
