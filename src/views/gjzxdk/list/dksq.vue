    ...
    <div class="tableWrap mt15">
      ...
      <div class="mt15">
        ...
        >
          ...
          <el-table-column prop="dkzje" label="贷款金额（元）">
          </el-table-column>
          <el-table-column prop="dkyhmc" label="贷款银行"> </el-table-column>
          <el-table-column prop="dkqx" label="贷款期限（月）">
          </el-table-column>
          <el-table-column prop="htbh" label="合同编号"> </el-table-column>
          <el-table-column prop="dkkssj" label="贷款开始时间">
          </el-table-column>
          <el-table-column prop="hzjym" label="回执校验码"> </el-table-column>
          <el-table-column
            prop="status"
            label="审批状态"
            sortable="custom"
