              ...
              <el-row>
                <el-col :span="24" class="rowStyle">
                  <el-form-item prop="zlmc">
                    <div class="wrap">
                      <div class="title">
                        <span style="color: red">*</span>专利（发明）名称
                      </div>

                      <div class="content">
                        <el-input
                          v-model="formAddLw.zlmc"
                          style="width: 300%"
                        ></el-input>
                      </div>
                    </div>
              ...
              <el-row>
                ...
                <el-col :span="12" class="rowStyle">
                  <el-form-item prop="sqr">
                    <div class="wrap">
                      <div class="title">
                        <span style="color: red">*</span>申请（发明）人
                      </div>
                      <div class="content">
              ...
              <el-row>
                <el-col :span="12" class="rowStyle">
                  <el-form-item prop="zlr">
                    <div class="wrap">
                      <div class="title">
                        <span style="color: red">*</span>专利权人
                      </div>
                      <div class="content">
