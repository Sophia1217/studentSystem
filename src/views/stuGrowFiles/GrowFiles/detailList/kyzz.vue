  ...
  data() {
    return {
      ...
      rules: {
        ...
        cbs: [{ required: true, message: "出版社不能为空", trigger: "blur" }],
        cbsjb: [
          {
            required: true,
            message: "出版社级别不能为空",
  ...
  methods: {
    ...
    editClick() {
      if (!this.checkFormEdit()) {
        ...
        formData.append("cbrq", data.cbrq);
        formData.append("cbs", data.cbs);
        formData.append("cgssdw", data.cgssdw);
        formData.append("cbsjb", data.cbsjb);
        formData.append("gtzz", data.gtzz);
        formData.append("id", data.id);
        formData.append("zzlb", data.zzlb);
        formData.append("zzmc", data.zzmc);
