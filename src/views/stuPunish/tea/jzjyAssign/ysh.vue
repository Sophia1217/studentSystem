    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        <div class="headerLeft">
          <span class="title">已处理页面</span> <i class="Updataicon"></i>
        </div>
...
<script>
import { yclList, yclListExecl } from "@/api/jzjyGwsq/index";
...
export default {
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      yclListExecl(this.exportParams)
        .then((res) => {
          this.downloadFn(res, "岗位已处理页面导出.xlsx", "xlsx");
