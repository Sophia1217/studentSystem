    ...
    <div class="tableWrap mt15">
      ...
      >
        ...
        <div style="margin-left: 30px; margin-right: 30px">
          ...
          >
            ...
            <el-form-item
              ...
              :rules="rules.common"
            >
              <el-select v-model="formEdit.jycfdjm" placeholder="请选择">
                <el-option
        ...
        <span slot="footer" class="dialog-footer footerFlex">
          ...
          <div class="btns fullGreen" @click="passEdit">
            <i class="icon passIcon"></i><span class="title1">通过</span>
          </div>
        </span>
      </el-dialog>
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      exportDsh(this.exportParams)
        .then((res) => {
          this.downloadFn(res, "违纪处分待审核列表导出.xlsx", "xlsx");
    ...
    passEdit() {
      if (!this.checkFormEdit()) {
        ...
        var params = {
          ...
          wjssmsXgbfzr: this.formEdit.wjssmsFdy,
          cfyjtkXgbfzr: this.formEdit.cfyjtkFdy,
          cfdjm: this.formEdit.jycfdjm,
          dwjyXgbfzr: this.formEdit.dwjyFdy,
          id: this.formEdit.id,
        };
        updateQgzxGw(params).then((res) => {
          // this.$message.success("修改并审核通过");
          this.pass();
        });
      }
    },
