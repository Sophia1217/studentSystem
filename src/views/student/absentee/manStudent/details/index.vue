            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12" class="rowStyle">
                <div class="wrap">
                  ...
                  <div v-if="isEdit == 1" class="content">
                    {{ getName(xslbOps, detailInfo.xsXjxx.xslbm_chinese) }}
                  </div>
                  <div v-if="isEdit == 2" class="content">
            ...
            <el-row :gutter="20">
              <el-col :span="12" class="rowStyle">
                <div class="wrap">
                  ...
                  <div v-if="isEdit == 2" class="content">
                    <el-input
                      v-model="detailInfo.xsJbxx.dywyyz"
              ...
              <el-col :span="12" class="rowStyle">
                <div class="wrap">
                  ...
                  <div v-if="isEdit == 2" class="content">
                    <el-input
                      v-model="detailInfo.xsJbxx.dywysp"
              ...
              <template slot-scope="scope">
                ...
                <div v-else>
                  <el-input
                    ...
                    :disabled="scope.row.csny_stuFlag == 2"
                    placeholder="请输入"
                  ></el-input>
                </div>
              </template>
              ...
              <template slot-scope="scope">
                ...
                <div v-else>
                  <el-input
                    ...
                    :disabled="scope.row.jkzkm_stuFlag == 2"
                    placeholder="请输入"
                  ></el-input>
                </div>
              </template>
              ...
              <template slot-scope="scope">
                ...
                <div v-else>
                  <el-input
                    ...
                    :disabled="scope.row.cygzdwdz_stuFlag == 2"
                    placeholder="请输入"
                  ></el-input>
                </div>
              </template>
              ...
              <template slot-scope="scope">
                ...
                <div v-else>
                  <el-input
                    ...
                    :disabled="scope.row.zyjszwm_stuFlag == 2"
                    placeholder="请输入"
                  ></el-input>
                </div>
              </template>
              ...
              <template slot-scope="scope">
                ...
                <div v-else>
                  <el-input
                    ...
                    :disabled="scope.row.zwjbm_stuFlag == 2"
                    placeholder="请输入"
                  ></el-input>
                </div>
              </template>
