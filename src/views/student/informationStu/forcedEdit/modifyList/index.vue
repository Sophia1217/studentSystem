<template>
  <div class="manStudent">
    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        <div class="headerLeft"><span class="title">强制修改名单列表</span> <i class="Updataicon"></i></div>
      ...
      <div class="mt15" v-if="tableData.length>0">
        ...
        <el-table-column type="index" label="序号" width="50"></el-table-column>
          ...
          <el-table-column prop="name" label="学生类别" sortable> </el-table-column>
          <el-table-column prop="name" label="修改时间" sortable> </el-table-column>
        </el-table>
      </div>
      <div class="noData" v-else>
        <img src="@/assets/images/noData.png" alt="" width="160px" height="160px">
