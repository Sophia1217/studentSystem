    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        <div class="headerLeft">
          <span class="title">学籍异动确认</span> <i class="Updataicon"></i>
        </div>
      ...
      <el-dialog :title="title2" :visible.sync="showConfirm" width="30%">
        <span>是否确认选择的{{ this.len }}条学籍异动的信息？</span>
        <span slot="footer" class="dialog-footer">
...
import { getStuStatusChangePageList, confirm } from "@/api/student/stuChange";
import { async } from "q";
export default {
  name: "changeConfirm",
  ...
  methods: {
    ...
    expTalk() {
      ...
      this.$set(this.exportParams, "status", "0");
      excelTest(this.exportParams)
        .then((res) => {
          that.downloadFn(res, "学籍异动未确认学生表.xlsx", "xlsx");
        })
        .catch((err) => {});
      this.showExportA = false;
    },
