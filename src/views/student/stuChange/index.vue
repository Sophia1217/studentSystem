<template>
  <div class="manStudent">
    <div class="searchWrap">
      ...
      <div class="moreSelect" v-if="isMore">
        ...
        <el-row :gutter="20" class="mt15">
          ...
          <el-col :span="20">
            <div class="checkbox">
              <checkboxCom :objProp="changType" @training="changTypeAll" @checkedTraining="changTypeCheck"></checkboxCom>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20" class="mt15">
          ...
          <el-col :span="20">
            <div class="checkbox">
              <checkboxCom :objProp="changWhy" @training="changWhyAll" @checkedTraining="changWhyCheck"></checkboxCom>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20" class="mt15">
          ...
          <el-col :span="20">
            <div class="checkbox">
              <checkboxCom :objProp="changTitanic" @training="changTitanicAll" @checkedTraining="changTitanicCheck"></checkboxCom>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20" class="mt15">
          ...
          <el-col :span="20">
            <div class="checkbox">
              <el-date-picker v-model="datePicker" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd" 
                type="date" placeholder="选择日期" @change="handleDatePicker" size="small"></el-date-picker>
            </div>
          </el-col>
        </el-row>
      </div>
    ...
    <div class="tableWrap mt15">
      <div class="headerTop">
        <div class="headerLeft"><span class="title">学籍异动学生列表</span> <i class="Updataicon"></i></div>
      ...
      <div class="mt15">
        ...
        <el-table-column type="index" label="序号" width="50"></el-table-column>
          ...
          <el-table-column prop="address" label="班级" sortable> </el-table-column>
          <el-table-column prop="address" label="异动类别" sortable> </el-table-column>
          <el-table-column prop="address" label="异动原因" sortable> </el-table-column>
          <el-table-column prop="address" label="异动操作人" sortable> </el-table-column>
          <el-table-column prop="address" label="异动日期" sortable> </el-table-column>
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="hadleDetail(scope.row)">
...
export default {
  ...
  data() {
    return {
      ...
      ethnic:{  // 名族
        checkAll: false,
        choose: [],
        checkBox: [{label:'汉族',val:1},{label: '蒙古族',val:2},{label:'藏族',val:3},{label:'满族',val:4},{label:'苗族',val:5},{label:'彝族',val:6},{label:'维吾尔族',val:7},{label:'土家族',val:8}],
        isIndeterminate: true
      },
      politica:{  // 政治面貌：
        checkAll: false,
      ...
      changType: { //异动类别：
        checkAll: false,
        choose: [],
        checkBox: [{label:'休学',val:1},{label: '自动退学',val:2},{label:'转专业',val:3},{label:'毕业',val:4},{label:'肄业',val:5}],
        isIndeterminate: true
      },
      changWhy: { //异动原因：
        checkAll: false,
        choose: [],
        checkBox: [{label:'成绩优秀',val:1},{label: '精神疾病',val:2},{label:'传染疾病',val:3},{label:'自动退学',val:4},{label:'其他疾病',val:5}],
        isIndeterminate: true
      },
      changTitanic: { //异动文号：
        checkAll: false,
        choose: [],
        checkBox: [{label:'【2022】1号',val:1},{label: '【2022】2号',val:2},{label:'XXXX',val:3},{label:'XXXX',val:4}],
        isIndeterminate: true
      },
      datePicker:'',
      tableData: [{ date: 1 }],
  ...
  methods: {
    ...
    changTypeCheck(value) {
      ...
      this.changType.isIndeterminate = checkedCount > 0 && checkedCount < this.changType.checkBox.length;
    ...
    changWhyCheck(value) {
      ...
      this.changWhy.isIndeterminate = checkedCount > 0 && checkedCount < this.changWhy.checkBox.length;
    ...
    changTitanicCheck(value) {
      let checkedCount = value.length;
      this.changTitanic.checkAll = checkedCount === this.changTitanic.checkBox.length;
      this.changTitanic.isIndeterminate = checkedCount > 0 && checkedCount < this.changTitanic.checkBox.length;
