    ...
    <div class="tableWrap mt15">
      ...
      <div class="mt15">
        ...
        >
          ...
          <el-table-column prop="tsg" label="图书馆" sortable="custom" />
          <el-table-column prop="xf" label="消费" sortable="custom" />
...
<script>
import { excelExportList, queryList } from "@/api/studyWarn/sl";
import {
  downLoad,
  deleteBmd,
  insertBmd,
